 ...
 * @property android_pack
 * @property android_class
 * @property android_url
...
class App extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, icon, listimage, desc, urlschemes, ituneslink, version, android_pack, android_class, android_url', 'length', 'max'=>255),
			array('html', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, icon, listimage, desc, urlschemes, ituneslink, html, version, usenum, android_pack, android_class, android_url', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('android_pack',$this->android_pack);
		$criteria->compare('android_class',$this->android_class);
		$criteria->compare('android_url',$this->android_url);
