...
/**
 * This is the model class for table "{{member_session}}".
 *
 * The followings are the available columns in table '{{member_session}}':
 * @property string $id
...
class Session extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, member_id, session', 'safe', 'on'=>'search'),
		);
	}
