...
class ApiBase
{
	...
	public static $success = array('errorCode' => ApiError::SUCCESS, 'errorMessage'=>'success', 'result'=>STATE_ENABLED);	// 操作成功
	public static $fail = array('errorCode' => ApiError::FAIL, 'errorMessage'=>'fail', 'result'=>STATE_DISABLED);// 操作失败
